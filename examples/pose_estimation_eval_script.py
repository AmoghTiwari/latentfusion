...
for object_id in [5,6,8,9]:
    ...
    estimator = pe.load_from_config('../configs/cross_entropy_linemod.toml', model, return_camera_history=False, verbose=False)
    ...
    sgd_estimator = pe.load_from_config('../configs/adam_slow.toml', model, track_stats=True, return_camera_history=True, num_iters=100)
